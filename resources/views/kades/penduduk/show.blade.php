        ...
        <div class="col-xl-4 col-md-6 mb-4">
            <div class="card shadow h-100 py-2 border-left-primary">
                <div class="card-body text-center">
                    <img class="img-profile rounded-circle mb-3" src="{{ asset('img/undraw_profile.svg') }}"
                        style="width: 100px;">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <tr>
                            ...
                            <td class="font-weight-bold">: {{ \Carbon\Carbon::parse($warga->tanggal_lahir)->age }} Tahun
                            </td>
                        </tr>
                        <tr>
                    ...
                    <div class="col-md-6">
                        <table class="table table-borderless table-sm">
                            ...
                            <tr>
                                ...
                                <td class="font-weight-bold">
                                    : {{ $warga->kk->kepalaKeluarga->nama_lengkap ?? '(Belum Diset)' }}
                                </td>
                            </tr>
                            <tr>
