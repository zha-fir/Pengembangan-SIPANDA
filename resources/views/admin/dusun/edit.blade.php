...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div>
        ...
        <h1 class="text-2xl font-bold text-slate-800 tracking-tight">Edit Data Dusun</h1>
         <p class="text-slate-500 text-sm mt-1">Perbarui informasi wilayah dusun.</p>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 md:p-8">
        ...
        <form action="{{ route('dusun.update', $dusun->id_dusun) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
