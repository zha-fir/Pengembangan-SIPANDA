        ...
        <div class="table-responsive">
            <table class="table table-bordered" id="dataTable">
                ...
                <tbody>
                    ...
                    @empty
                    <tr><td colspan="5" class="text-center">Belum ada ajuan surat baru.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
            ...
            <form id="formKonfirmasi" action="" method="POST"> {{-- Action diisi JS --}}
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nomor_surat" name="nomor_surat" required placeholder="Contoh: PLB/2025/XI/123">
                    </div>
                    <div class="form-group">
                        <label for="id_pejabat_desa">Pilih Tanda Tangan (Pejabat Desa)</label>
                        <select class="form-control" id="id_pejabat_desa" name="id_pejabat_desa" required>
                            <option value="">-- PILIH TANDA TANGAN --</option>
                            {{-- Loop dari $pejabatList yang dikirim Controller --}}
