        ...
        <div class="card-body">
            ...
            <form action="{{ route('warga.update', $warga->id_warga) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="id_kk" name="id_kk">
                        ...
                        @foreach ($kkList as $kk)
                            <option value="{{ $kk->id_kk }}" {{-- Memilih KK yang sesuai dengan data lama: $warga->id_kk --}}
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="status_perkawinan" name="status_perkawinan"
                                value="{{ old('status_perkawinan', $warga->status_perkawinan) }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                ...
                @if($warga->user)
                    ...
                    {{-- ... kode checkbox reset password di atas ... --}}

                    <div class="form-group">
                        <label for="password">Password Baru (Mininal 6 Karakter)</label>
                    ...
                    {{-- ... tombol Batal & Simpan di bawah ... --}}
                @else
                    <h5><i class="fas fa-key"></i> Buat Akun Login</h5>
                    <p class="text-danger">Warga ini belum memiliki akun login. Gunakan fitur "Import Warga" untuk membuat akun
                        secara otomatis.</p>
                @endif
